...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Cores principais - Sistema moderno inspirado em apps 2024/2025
        primary: {
          50: '#f0f4ff',
          100: '#e0e7ff',
          200: '#c7d2fe',
        ...
        // Verde Jurídico Moderno (inspirado no Duolingo)
        legal: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
        ...
        // Roxo Moderno (tendência 2024/2025)
        purple: {
          50: '#faf5ff',
          100: '#f3e8ff',
          200: '#e9d5ff',
      ...
      boxShadow: {
        // Sombras modernas inspiradas em glassmorphism
        ...
        'glow-legal': '0 0 20px rgba(34, 197, 94, 0.3)',
        'glow-purple': '0 0 20px rgba(168, 85, 247, 0.3)',
        'glow-cyan': '0 0 20px rgba(6, 182, 212, 0.3)',
        'glow-rose': '0 0 20px rgba(244, 63, 94, 0.3)',
        // Sombras coloridas modernas
        'colored-primary': '0 10px 25px -5px rgba(99, 102, 241, 0.4)',
        'colored-legal': '0 10px 25px -5px rgba(34, 197, 94, 0.4)',
        'colored-gold': '0 10px 25px -5px rgba(245, 158, 11, 0.4)',
        'colored-purple': '0 10px 25px -5px rgba(168, 85, 247, 0.4)',
      },
      animation: {
        // Animações modernas
      ...
      backgroundImage: {
        ...
        'legal-pattern': "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23f1f5f9' fill-opacity='0.4'%3E%3Cpath d='m36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")",
